	...
	public class NorqueReader : IModelReader
	{
		...
		public IEntity GetNextEntity()
		{
			if(entityEnum.MoveNext() == false)
				return null;
			return (IEntity)entityEnum.Current;
		}
		...
		private ModelImpl ReadModel(XmlElement el)
		{
		...
		private EntityImpl ReadEntity(ModelImpl model, XmlElement el)
		{
			EntityImpl e = new EntityImpl(model);
		...
		private AttributeImpl ReadAttribute(EntityImpl entity, XmlElement el)
		{
			AttributeImpl a = new AttributeImpl(entity);
		...
		private RelationshipImpl ReadReleationship(EntityImpl entity, XmlElement el)
		{
			RelationshipImpl r = new RelationshipImpl(entity);
