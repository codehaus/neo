...
public class TitleBase : EntityObject
{
	...
	{
		get { return (Publisher)Context.GetObjectFromTable("publishers", new object[] { Row["pub_id"] }); }
...
public class TitleAuthorBase : EntityObject
{
	...
	{
		get { return (Title)Context.GetObjectFromTable("titles", new object[] { Row["title_id"] }); }
		set { Row["title_id"] = (value != null) ? value.Row["title_id"] : null; }
	}

	public virtual Author Author
	{
		get { return (Author)Context.GetObjectFromTable("authors", new object[] { Row["au_id"] }); }
